			...
			<div className="card-block px-auto w-30" style={{ position: 'absolute' }} >
				<Card style={{ boxShadow: '0 30px 40px rgba(0,0,0,4)', borderTop: 'solid 25px #ed1c22', opacity: '.92' }} >
					<CardBody className="mx-2">
						...
						<Button href={ this.props.button1Link } size="lg" className="blue-button mx-4 my-3" style={{ position: 'relative', zIndex: '10', fontWeight: '600', color: '#fff' }}>{ this.props.button1Text }</Button>
